...
//  Scene2D
//
//  Created by Manoj Kumar on 05/07/24.
//
...
VertexOutput vertex VertexMainScene(uint vertextID [[vertex_id]], device const VertexInput* verticies [[buffer(0)]], constant float4x4& transform [[buffer(1)]]) {
...
half4 fragment FragmentMainScene(VertexOutput frag [[stage_in]]) {
//    stdout << "hello";
