...
//};
//
//class Triangle: public ShapeWrapper<uint16>::Shape {
//public:
...
//    Triangle(float side): ShapeWrapper<uint16>::Shape(new Vertex3D[3], 3, indicesL, 3) {
...
//};
//
//class NGon: public ShapeWrapper<uint16>::Shape {
//public:
//    NGon(float radius, int sides): ShapeWrapper<uint16>::Shape(new Vertex3D[sides + 1], sides + 1, new uint16[2 * sides + 2], 2 * sides + 2) {
//        
